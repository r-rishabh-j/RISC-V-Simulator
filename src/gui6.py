...
class Ui_MainWindow(object):
    ...
    def update_registers(self, arr):
        ...
        self.tableWidget2.setHorizontalHeaderItem(0, QtWidgets.QTableWidgetItem("Reg"))
        self.tableWidget2.setHorizontalHeaderItem(1, QtWidgets.QTableWidgetItem("Value"))
        for i in range(32):
            text = "x" + str(i)
    ...
    def update_memory(self, dic):
        ...
        self.tableWidget.setHorizontalHeaderItem(0, QtWidgets.QTableWidgetItem("Address"))
        self.tableWidget.setHorizontalHeaderItem(1, QtWidgets.QTableWidgetItem("+0"))
        self.tableWidget.setHorizontalHeaderItem(2, QtWidgets.QTableWidgetItem("+1"))
        self.tableWidget.setHorizontalHeaderItem(3, QtWidgets.QTableWidgetItem("+2"))
        self.tableWidget.setHorizontalHeaderItem(4, QtWidgets.QTableWidgetItem("+3"))
        for key in dic:
            lst.append(key)
        lst.sort()
        for x in lst:
